...
export const ProductCard = ({ product }) => {
    ...
    return (
        <div className="relative max-w-sm bg-white shadow-lg rounded-2xl m-2 flex flex-col justify-between hover:shadow-2xl hover:scale-[1.02] transition-transform duration-300">
            ...
            {/* Product Image */}
            <div className="h-full w-full flex items-center justify-center bg-gray-50 rounded-t-2xl overflow-hidden">
                <img
                    src={
                        product.images?.[0] ||
            ...
            <div className="p-5 flex flex-col flex-grow">
                <h1 className="text-lg font-semibold mb-1 line-clamp-1 text-gray-900">
                    {product.title}
                </h1>
